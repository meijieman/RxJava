    ...
    public void onClick(View v){
        ...
        switch(v.getId()) {
            ...
            case R.id.btn_6:
                ...
                break;
            case R.id.btn_7:
                startActivity(new Intent(this, Execise1Activity.class));
                break;
            case R.id.btn_8:
                startActivity(new Intent(this, Execise2Activity.class));
                break;
            case R.id.btn_9:
                startActivity(new Intent(this, RxTaskActivity.class));
                break;
            default:
                break;
        }
